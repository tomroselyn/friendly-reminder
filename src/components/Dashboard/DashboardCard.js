        ...
        return (
            <Grid item xs={3}>
                <Card className="dashboardCard">
                    <CardContent>
                        <h4 className="cardHeader">{this.props.friend.first_name} {this.props.friend.last_name}</h4>
                        <div className={`${this.props.due}Box`}>
                            ...
                            <br />due<br /><span className="cardDate">{this.props.friend.due_date.substr(0, 10)}</span>
                        </div>
                        <div>
                            last contacted <br />
                            <span className="cardDate">{this.props.friend.last_date.substr(0, 10)}</span>
